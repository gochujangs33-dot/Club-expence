...
const TRANSLATIONS = {
  ko: {
    ...
    /* ── 신규 클럽 등록 ── */
    'ph.new_club_name': '클럽명 입력',

    /* ── 수정 모드 배너 ── */
    'label.edit_mode': '수정 모드',
    'label.editing_in_progress': '정산 수정 중',

    /* ── 분할결제 힌트 ── */
    'hint.split_auto': '총금액 - 법인카드 금액로 자동 계산됨',

    /* ── 버튼 상태 ── */
    'state.generating': '생성 중...',
    'state.saved': '저장 완료!',
    'state.save_failed': '저장 실패',
    'state.downloading': '다운로드 완료!',
    'state.download_failed': '다운로드 실패',

    /* ── alert/confirm 메시지 ── */
    'alert.directory_delete_restricted': '명부 삭제는 관리자 또는 개발자만 가능합니다.',
    'alert.edit_restricted_admin_only': '이름/사번 수정은 관리자만 가능합니다.',
    'alert.excel_download_failed': '엑셀 파일 다운로드에 실패했습니다: ',
    'alert.files_downloaded': '정산서/사진 파일이 다운로드되었습니다. 메일 앱에서 직접 첨부해주세요.',
    'alert.save_error_network': '수정 내용 저장 중 오류가 발생했습니다. 네트워크를 확인해 주세요.',
    'confirm.finalize_settlement': '정산을 확정하시겠습니까?\n확정하면 현재 비용 및 참석자 데이터가 초기화됩니다.',
    'alert.enter_club_name': '클럽명을 입력해주세요.',
    'confirm.clear_all_attendees': '등록된 모든 참석자 명단을 비우시겠습니까?',
    'alert.rules_saved': '정산 구간 및 비율 설정이 저장되어 모든 클럽에 일괄 적용됩니다.',
    'confirm.reset_rules': '정산 기준 및 비율을 초기 기본값으로 복원하시겠습니까? (모든 클럽에 적용됩니다)',
    'alert.select_items_to_delete': '삭제할 항목을 선택해주세요.',
    'confirm.logout': '로그아웃 하시겠습니까? (로컬 기기 모드로 전환됩니다)',
    'alert.register_success': '님, 회원 등록이 완료되었습니다!',
    'alert.pin_digit_required': 'PIN 번호는 6자리 숫자여야 합니다.',
    'alert.pin_already_used': '이미 사용 중인 PIN 번호입니다.',
    'alert.edit_user_failed': '회원 정보 수정에 실패했습니다.',
    'alert.delete_user_failed': '회원 삭제에 실패했습니다.',
    'confirm.delete_club': '클럽을 삭제하시겠습니까?',
    'alert.total_budget_save_failed': '총 클럽비용 저장에 실패했습니다. 온라인 상태를 확인해주세요.',
    'alert.delete_failed_network': '삭제에 실패했습니다. 온라인 상태를 확인해주세요.',
    'status.online': '🌐 온라인',
    'status.unknown': '알 수 없음',
    'empty.no_requests': '요청사항이 없습니다.',
    'empty.no_clubs': '등록된 클럽이 없습니다.',

    /* ── 클럽 관리 카드 ── */
    'club.assigned_budget': '배정 예산',
    'club.remaining_budget': '잔여 예산',
    'club.prior_used': '이전사용',
    'btn.add_budget': '추가 배정',
    'btn.edit': '수정',
    'btn.delete': '삭제',
    'btn.edit_done': '💾 수정 완료',
    'btn.add_club_active': '➕ 클럽 추가',
    'hint.prior_used_admin': '💡 "이전 사용 금액"은 각 사용자가 정산 결과 화면의 ⚙️ 설정에서 "기존에 사용한 누적 금액"으로 직접 입력합니다.',
    'label.allocated_unallocated': '배정 합계 / 미배정',
    'state.saved_check': '✔️ 저장되었습니다.',

    /* ── 이력 카드 공통 ── */
    'badge.edited': '수정됨',
    'label.edited_at': '수정',
    'label.settler': '정산인',
    'label.default_club': '기본 클럽',
    'status.offline': '오프라인',
    'hist.per_person_self_pay': '인당 자부담',
    'hist.view_details_admin': '상세 지출 및 참석자 명단 보기',
    'hist.attendees_label': '참석자',
    'hist.none': '없음',
  },
  ...
  en: {
    ...
    'ph.new_club_name': 'Enter club name',

    /* ── Edit Mode Banner ── */
    'label.edit_mode': 'Edit Mode',
    'label.editing_in_progress': 'Editing settlement',

    /* ── Split Payment Hint ── */
    'hint.split_auto': 'Auto-calculated: Total − Corp Card amount',

    /* ── Button States ── */
    'state.generating': 'Generating...',
    'state.saved': 'Saved!',
    'state.save_failed': 'Save Failed',
    'state.downloading': 'Downloaded!',
    'state.download_failed': 'Download Failed',

    /* ── Alert / Confirm Messages ── */
    'alert.directory_delete_restricted': 'Only admin or developer can delete directory entries.',
    'alert.edit_restricted_admin_only': 'Only admin can edit name or employee ID.',
    'alert.excel_download_failed': 'Failed to download Excel file: ',
    'alert.files_downloaded': 'Files downloaded. Please attach them in your mail app.',
    'alert.save_error_network': 'Error saving changes. Please check your network.',
    'confirm.finalize_settlement': 'Finalize settlement?\nExpenses and attendees will be cleared.',
    'alert.enter_club_name': 'Please enter a club name.',
    'confirm.clear_all_attendees': 'Clear all attendees?',
    'alert.rules_saved': 'Rules saved and applied to all clubs.',
    'confirm.reset_rules': 'Restore default rules? (Applied to all clubs)',
    'alert.select_items_to_delete': 'Please select items to delete.',
    'confirm.logout': 'Logout? (Switch to offline mode)',
    'alert.register_success': ', registration complete!',
    'alert.pin_digit_required': 'PIN must be exactly 6 digits.',
    'alert.pin_already_used': 'This PIN is already in use.',
    'alert.edit_user_failed': 'Failed to edit user.',
    'alert.delete_user_failed': 'Failed to delete user.',
    'confirm.delete_club': 'Delete this club?',
    'alert.total_budget_save_failed': 'Failed to save total budget. Check your connection.',
    'alert.delete_failed_network': 'Delete failed. Check your connection.',
    'status.online': '🌐 Online',
    'status.unknown': 'Unknown',
    'empty.no_requests': 'No requests.',
    'empty.no_clubs': 'No clubs registered.',

    /* ── Club Management Card ── */
    'club.assigned_budget': 'Assigned Budget',
    'club.remaining_budget': 'Remaining',
    'club.prior_used': 'Prior used',
    'btn.add_budget': 'Add Budget',
    'btn.edit': 'Edit',
    'btn.delete': 'Delete',
    'btn.edit_done': '💾 Save',
    'btn.add_club_active': '➕ Add Club',
    'hint.prior_used_admin': '💡 "Prior used amount" is entered by each user in the ⚙️ Settings panel of the settlement result screen.',
    'label.allocated_unallocated': 'Allocated / Unallocated',
    'state.saved_check': '✔️ Saved.',

    /* ── History Card Common ── */
    'badge.edited': 'Edited',
    'label.edited_at': 'Edited',
    'label.settler': 'Settler',
    'label.default_club': 'Default Club',
    'status.offline': 'Offline',
    'hist.per_person_self_pay': 'Per-person self-pay',
    'hist.view_details_admin': 'View spending & attendee details',
    'hist.attendees_label': 'Attendees',
    'hist.none': 'None',
  }
};
...
function applyTranslations() {
  ...
  // 클럽 선택 드롭다운 첫 번째 / 두 번째 옵션
  const clubNameSelect = document.getElementById('club-name-select');
  if (clubNameSelect) {
    if (clubNameSelect.options[0] && clubNameSelect.options[0].value === '') {
      clubNameSelect.options[0].text = t('header.club_placeholder');
    }
    // __new__ 옵션이 있으면 텍스트 갱신
    Array.from(clubNameSelect.options).forEach(opt => {
      if (opt.value === '__new__') opt.text = t('header.club_new');
    });
  }
  // 클럽별 이력 전체클럽 옵션
  ...
  // 로그인 상태 배지 — 로그인/오프라인 상태에 따라 갱신 (data-i18n 덮어쓰기 방지)
  const statusBadge = document.getElementById('login-status-badge');
  if (statusBadge) {
    if (typeof AppState !== 'undefined' && AppState.isLoggedIn) {
      const name = AppState.userName || t('status.unknown');
      const pin = AppState.currentPin || '';
      statusBadge.innerHTML = `${t('status.online')} (${name} / PIN: ${pin})`;
    } else {
      statusBadge.textContent = t('header.offline');
    }
  }
  // 언어 pill 버튼 active 상태 동기화
  const langWrap = document.getElementById('login-lang-select-wrap');
  if (langWrap) {
    langWrap.querySelectorAll('.lang-pill').forEach(btn => {
