...
- **일반 사용자 정산 이력(v1.6.262)**: 클럽별 사용 요약·총 상품비·행사별 비용 표를 바로 표시한다. 본인 정산의 행사 날짜를 누르면 수정 화면으로 이동하며, 참석 인원은 이름·사번 명단 확인·복사, `엑셀` 버튼은 해당 행사 엑셀 재다운로드를 제공한다.
...
현재 버전: **v1.6.264** (`sw.js` `APP_VERSION`)
