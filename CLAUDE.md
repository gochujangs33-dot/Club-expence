...
- **차트 탭**: 월별 추이 / 클럽별 예산 소진율 / 카테고리 비중 / 클럽별 정산 횟수 / 행사별 참석 인원(v1.6.234, v1.6.236 가로 목록형, v1.6.245 최근 10건·왼쪽 레이블 항상 표시, v1.6.251 호버 명단·클릭 명단복사) /
...
현재 버전: **v1.6.251** (`sw.js` `APP_VERSION`)
